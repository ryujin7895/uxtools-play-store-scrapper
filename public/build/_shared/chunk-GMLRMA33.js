...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1741070286731.0378";
}
function Sidebar() {
  _s();
  const location = useLocation();
  const isActive = (path2) => location.pathname === path2;
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("aside", { id: "logo-sidebar", className: "fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700", "aria-label": "Sidebar", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("ul", { className: "space-y-2 font-medium", children: [{
    path: "/",
  ...
  }].map((item) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("li", { children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Link, { to: item.path, className: `flex items-center p-2 text-gray-900 rounded-lg dark:text-white ${isActive(item.path) ? "bg-gray-100 dark:bg-gray-700" : "hover:bg-gray-100 dark:hover:bg-gray-700"} group`, children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(item.icon, { className: "w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" }, void 0, false, {
      fileName: "app/components/common/Sidebar.tsx",
      lineNumber: 41,
      columnNumber: 17
    }, this),
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("span", { className: "ms-3", children: item.label }, void 0, false, {
      fileName: "app/components/common/Sidebar.tsx",
      lineNumber: 42,
      columnNumber: 17
    }, this)
...
object-assign/index.js:
  ...
  *)
*/
//# sourceMappingURL=/build/_shared/chunk-GMLRMA33.js.map
